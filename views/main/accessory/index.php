...
<?php require_once("models/product.php"); 
    ...
    $totalProduct = count($accessory); // Tổng số sản phẩm
        ...
        <div class="col-lg-9 px-0" id="accessory-galery">
            <div class="container-fluid px-0 mx-0" id="product-container">
                ...
                <div class="row">
                    ...
                    echo  "<p class='card-text text-secondary accessory-type'>".$value->product_subcategory."</p>";
