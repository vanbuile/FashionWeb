...
<?php require_once("models/product.php"); 
    ...
    $totalProduct = count($clothing); // Tổng số sản phẩm
        ...
        <div class="col-lg-9 px-0" id="clothing-galery">
            <div class="container-fluid px-0 mx-0" id="product-container">
                ...
                <div class="row">
                    ...
                    echo  "<p class='card-text text-secondary clothing-type'>".$value->product_subcategory."</p>";
